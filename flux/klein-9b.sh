...
HF_MODELS=(
    "https://huggingface.co/Comfy-Org/flux2-klein/resolve/main/split_files/diffusion_models/flux-2-klein-4b.safetensors|${MODELS_DIR}/diffusion_models/flux-2-klein-4b.safetensors"
    
    # Diffusion model (base)
    "https://huggingface.co/Comfy-Org/flux2-klein/resolve/main/split_files/diffusion_models/flux-2-klein-base-4b.safetensors|${MODELS_DIR}/diffusion_models/flux-2-klein-base-4b.safetensors"
